...
export default function Home() {
  ...
  return (
    <>
      ...
      <p><a href={"ma"+"ilto"+":zach"+"blume"+"@"+"gm"+"ail.com"}>Zach Blume</a>, Dec 14 2023. <Link href="https://github.com/zachblume/chatgpt-ui-fix/blob/main/pages/index.js">Read the code on github</Link></p>
      <h2>Problem</h2>
      <p>
